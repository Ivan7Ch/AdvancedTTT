//
//  PlayWithPCViewController.swift
//  AdvancedTTT
//
...
class PlayWithPCViewController: BaseBackgroundViewController, GameViewModelDelegate {
    ...
    private var viewModel: PlayWithPCViewModel!
...
extension PlayWithPCViewController: UICollectionViewDataSource {
...
extension PlayWithPCViewController: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension PlayWithPCViewController : UICollectionViewDragDelegate {
...
extension PlayWithPCViewController : UICollectionViewDropDelegate {
...
extension PlayWithPCViewController: GADFullScreenContentDelegate {
