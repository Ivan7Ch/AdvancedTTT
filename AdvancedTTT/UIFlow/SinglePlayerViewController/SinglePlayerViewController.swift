...
class SinglePlayerViewController: UIViewController, OnlineGameViewModelDelegate {
    ...
    var viewModel: SinglePlayerViewModel!
...
extension SinglePlayerViewController: UICollectionViewDataSource {
...
extension SinglePlayerViewController: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension SinglePlayerViewController : UICollectionViewDragDelegate {
...
extension SinglePlayerViewController : UICollectionViewDropDelegate {
...
extension SinglePlayerViewController: GADFullScreenContentDelegate {
